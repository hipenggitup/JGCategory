...
// JGCategory
#define COCOAPODS_POD_AVAILABLE_JGCategory
#define COCOAPODS_VERSION_MAJOR_JGCategory 0
#define COCOAPODS_VERSION_MINOR_JGCategory 1
#define COCOAPODS_VERSION_PATCH_JGCategory 0
